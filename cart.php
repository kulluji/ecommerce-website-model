    ...
    <div id="content_area">
        ...
        <div id="products_box">
           <form action="" method="post" enctype="multipart/form-data">
              <table align="center" border="2 groove red" bgcolor="pink" width="700">
                 <tr>
                            ...
                            while($final_u=mysqli_fetch_array($u_q))
                            {
                              ...
                              ?>
                                      <tr align="center">
                                        ...
                                        <td><select name="qty" value="<?php echo $qty?>" onChange="document.write(    
                                          <?php 
                                            if(isset($_POST['qty']))
                                            {   echo "if condition is working working working working working working";
											    $p_id=$_GET['pro_id'];
                                                $qty=$_POST['qty'];
												$i="update cart set qty='$qty' where p_id='$p_id'";
												$i_f=mysqli_query($con , $i);
												$_SESSION['qty']=$qty; 
												echo "<script>window.open('cart.php','_self')</script>";
											}
											else
											{echo "if condition is not working";}
										  ?>);">
                                              <option style="background:red;"><?php echo $qty ?></option>
                                              <option>1</option>
                                              <option>2</option>
                                              <option>3</option>
                                              <option>4</option>
                                        ...
                                        <td><?php $subsum=$subsum+$single_price*$qty;
                                                  echo $single_price*$qty ?> </td>

                                     </tr>
                          <?php  }  
                    } ?>
                   <tr>
                      <td colspan="4" align="right" style="line-height:25px;padding:5px 0 5px 0;" ><p style="margin-right:8px;"><b>Sub total:</b></p></td>
                       <td colspan="4" align="center" style="line-height:25px;padding:5px 0 5px 0;" ><p style="margin-right:8px;"><?php echo $subsum; ?></p></td>
                  </tr>
                  <tr align="center">
