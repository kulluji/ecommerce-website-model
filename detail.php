...
{ $prod_id=$_GET['prod_id'];
  global $con;
  $q="select * from products where product_id='$prod_id'";
  $f_q=mysqli_query($con,$q);
    ...
    {   
        ...
        echo "<div id='detail_product'>
                 <h2  style='padding:0px;margin:5px;'>$product_title</h2>
                 <img src='admin_area/uploaded_images/$product_image' width='280' height='280'style='border:2px solid green;' /> 
                 <p style='margin-top:5px;'><b style='color:black;'>Rs $product_price.00</b></p>
                 <p style='margin-top:5px;'><b style='color:black;'>$product_desc</b></p>
                 <a href='index.php' style='clear:both;float:left;text-decoration:none;margin-left:5px;'>Go BACK</a>
